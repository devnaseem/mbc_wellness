...
mixin _$WellnessState {
  AsyncValue<List<WellnessItemModel>> get wellnessList =>
...
abstract class $WellnessStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AsyncValue<List<WellnessItemModel>> wellnessList});
}
    ...
    return _then(_value.copyWith(
      wellnessList: null == wellnessList
          ...
          : wellnessList // ignore: cast_nullable_to_non_nullable
              as AsyncValue<List<WellnessItemModel>>,
    ) as $Val);
  }
}
...
class _$WellnessStateImpl implements _WellnessState {
  const _$WellnessStateImpl({this.wellnessList = const AsyncLoading()});

  @override
  @JsonKey()
  final AsyncValue<List<WellnessItemModel>> wellnessList;

  @override
  String toString() {
    return 'WellnessState(wellnessList: $wellnessList)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, wellnessList);
